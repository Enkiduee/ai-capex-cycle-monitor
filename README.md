...
- 减持与融资雷达：内部人交易按滚动一个月区分 Form 4 已售、Form 144 拟售与尚待匹配数量；公司融资另按滚动 12 个月区分 ATM / 增发 / 私募、普通债券 / 贷款和可转债，并分别保留计划额度、发行本金、已关闭额度或净募集额口径。首版融资事件录入 4 / 12 家，待补录不按零融资处理
...
| `data/insider-sales.json` | 12 只重点标的最近一个月的已售、拟售与待确认明细，以及滚动 12 个月的 ATM / 公司股权、发债 / 贷款和可转债事件、规模口径与官方来源 |
