...
- 减持雷达：按滚动一个月核对 12 只重点标的，区分 Form 4 / 已实施公告的实际出售、Form 144 / 减持计划的拟售通知，以及尚未被成交披露匹配的待确认数量；支持公司搜索、状态筛选、披露流水与原始来源跳转
...
| `data/insider-sales.json` | 12 只重点标的最近一个月的已售、拟售通知、待确认拟售、逐笔披露与 SEC / 巨潮资讯来源 |
